...
from model_nn import ActorCritic
...
parser.add_argument('--T-max', type=int, default=50000000000, metavar='STEPS', help='Number of training steps')
...
parser.add_argument('--evaluation-interval', type=int, default=250000, metavar='STEPS', help='Number of training steps between evaluations (roughly)')
parser.add_argument('--evaluation-episodes', type=int, default=10, metavar='N', help='Number of evaluation episodes to average over')
parser.add_argument('--render', action='store_true', help='Render evaluation agent')
parser.add_argument('--name', type=str, default='results', help='Save folder')
parser.add_argument('--env', type=str, default='SpaceInvaders-v0',help='environment name')
...
if __name__ == '__main__':
  ...
  shared_average_model = ActorCritic(env.observation_space, env.action_space, args.hidden_size, args.sigma_init, args.no_noise)
